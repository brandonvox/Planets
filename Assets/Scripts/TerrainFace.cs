...
public class TerrainFace
{
    ...
    public TerrainFace(ShapeGenerator shapeGenerator, Vector3 normalDirection, int resolution, Mesh mesh)
    {
    ...
    public void ConstructMesh()
    {
        ...
        for (int i = 0; i < resolution; i++)
        {
            for(int j = 0; j < resolution; j++)
            {
                ...
                vertices[vertexIndex] = shapeGenerator.CalculatePositionOnPlanet(positionOnUnitSphere);
